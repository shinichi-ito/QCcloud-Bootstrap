...
@Component({
  selector: 'app-claim-list-all-syousai',
  templateUrl: './claim-list-all-syousai.component.html',
  styleUrls: ['./claim-list-all-syousai.component.css']
})
export class ClaimListAllSyousaiComponent  {
  fileList:any;
  public data;
  newclaimList;
  newclaimList2:any[]=[];
